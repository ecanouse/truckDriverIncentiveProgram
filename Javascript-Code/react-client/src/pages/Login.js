    ...
    return (
      <div className='LoginPage'>
        ...
        <form onSubmit={this.submit}>
          ...
          <a className='Reset-UN-PASS' href='ResetPass'>Click here to reset your Password<br/></a>
          <a className='Reset-UN-PASS' href='Signup'><br/>Click here to make a new account</a> 
        </div>
      </div>      
    );
  }
